...
//#2
let config = {
    appid:'9dbdb86701e54900ac8343fac8f0e15a',
    token:'007eJxTYNiQkjBNzs4tbE9YtmKtktW01vxHarx6/oVKF+y+Mbl7KSkwWKYkpSRZmJkbGKaamlgaGCQmWxibGKcBqTSDVEPTRAnFyJSGQEaG/5yyLIwMEAjiszFkpCbmlGQwMAAAOmMbUQ==',
    uid:null,
    channel:'health',
}
...
let handleUserJoined = async (user, mediaType) => {
    ...
    if (mediaType === 'video'){
        ...
        player = `<div id="responsive_video"> 
